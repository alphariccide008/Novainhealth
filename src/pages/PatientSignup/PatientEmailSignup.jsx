...
const PatientEmailSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/patientlogin', { state: { email: formData.email } });
      }, 2000);
    } catch (error) {
          ...
          <div className="md:w-1/2 border md:border-[#46B8E3] lg:border-[#46B8E3]">
            ...
            <form onSubmit={handleSubmit} className="px-[3%] lg:px-[20%] bg-white text-center space-y-4">
              ...
              <p className="text-sm pb-[15%]">
                Already have an account? <Link to="/patientlogin" className="text-[#46B8E3] hover:underline">Log in</Link>
              </p>
            </form>
          </div>
        </div>
...
export default PatientEmailSignup;